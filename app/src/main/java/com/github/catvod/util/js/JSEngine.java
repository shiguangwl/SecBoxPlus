package com.github.catvod.util.js;
    ...
    public class JSThread {
        ...
        void initLocalStorage() {
            ...
            console.setProperty("get", new JSCallFunction() {
                @Override
                public Object call(Object... args) {
                    SharedPreferences sharedPreferences = App.instance.getSharedPreferences("js_engine_" + args[0].toString(), Context.MODE_PRIVATE);
    ...
    static String loadModule(String name) {
        try {
            ...
            if (name.startsWith("assets://")) {
                InputStream is = App.instance.getAssets().open(name.substring(9));
