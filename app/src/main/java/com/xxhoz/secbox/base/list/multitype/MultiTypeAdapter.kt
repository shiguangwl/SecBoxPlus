...
open class MultiTypeAdapter @JvmOverloads constructor(
     ...
     * @since v2.4.1
     */
    open var items: MutableList<BaseViewData<*>> = mutableListOf(),
    ...
    override fun onCreateViewHolder(parent: ViewGroup, indexViewType: Int): RecyclerView.ViewHolder {
        ...
        return types.getType<Any>(indexViewType).delegate.onCreateViewHolder(inflater, parent.context, parent)
    }
